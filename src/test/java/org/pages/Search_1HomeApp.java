...
public class Search_1HomeApp extends BaseClass{
	public Search_1HomeApp(){
		PageFactory.initElements(driver,this);
	}
	@FindBy(xpath="//a[text()='All Categories']")
	 private WebElement allCategories;
	@FindBy(xpath="//ul[@class='select-options']//li[4]")
	 private WebElement selProduct;
	 @FindBy(id="key")
	private WebElement txtEnter;
	 @FindBy(id="search_btn")
	 private WebElement searchBtn;
	 @FindBy(xpath="//div[@class='allproduct_lis']//li[2]")
